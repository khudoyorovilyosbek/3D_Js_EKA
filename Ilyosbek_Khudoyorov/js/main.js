...
var lvl_one_map = [
    { name: "floor", height: 4000, width: 4000, posX: 0, posY: 200, posZ: 0, rotX: 90, rotY: 0, rotZ: 0, color: "violet", opacity: 1, pattern: "url('Assets/floorr.jpg')"},
    { name: "ceiling", height: 4000, width: 4000, posX: 0, posY: -200, posZ: 0, rotX: 90, rotY: 0, rotZ: 0, color: "green", opacity: 1, pattern: "url('Assets/Roof.jpg')" },
    { name: "right wall", height: 400, width: 4000, posX: 2000, posY: 0, posZ: 0, rotX: 0, rotY: 90, rotZ: 0, color: "blue", opacity: 1, pattern: "url('Assets/Walll.jpg')" },
    { name: "left wall", height: 400, width: 4000, posX: -2000, posY: 0, posZ: 0, rotX: 0, rotY: -90, rotZ: 0, color: "orange", opacity: 1,pattern: "url('Assets/Walll.jpg')" },
     { name: "hinter wall", height: 400, width: 4000, posX: 0, posY: 0, posZ: -2000, rotX: 0, rotY: 0, rotZ: 0, color: "yellow", opacity: 1, pattern: "url('Assets/Walll.jpg')" },
...
{ name:"maze1", height:400, width:1200, posX:-800, posY:0, posZ:1200, rotX:0, rotY:0, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze2", height:400, width:1200, posX:800, posY:0, posZ:1200, rotX:0, rotY:0, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze3", height:400, width:1200, posX:-800, posY:0, posZ:-1200, rotX:0, rotY:0, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze4", height:400, width:1200, posX:800, posY:0, posZ:-1200, rotX:0, rotY:0, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze5", height:400, width:1200, posX:-1400, posY:0, posZ:0, rotX:0, rotY:90, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze6", height:400, width:1200, posX:1400, posY:0, posZ:0, rotX:0, rotY:90, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze7", height:400, width:800, posX:0, posY:0, posZ:1800, rotX:0, rotY:90, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" },

{ name:"maze8", height:400, width:800, posX:0, posY:0, posZ:-1800, rotX:0, rotY:90, rotZ:0, color:"gray", opacity:1, pattern:"url('Assets/Brickwall.jpg')" } 
